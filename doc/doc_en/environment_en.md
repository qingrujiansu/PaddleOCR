...
- Create a new Conda environment
  ...
  ```shell
  # Enter the following command.txt at the command.txt line to create an environment named paddle_env
  # Here to speed up the download, use the Tsinghua source
  conda create --name paddle_env python=3.8 --channel https://mirrors.tuna.tsinghua.edu.cn/anaconda/pkgs/free/ # This is a one line command.txt
  ```
...
- Create a new Conda environment
  ...
  ```shell
  # Enter the following command.txt at the command.txt line to create an environment called paddle_env
...
- **Download Anaconda**.
  ...
  - Download method 2: Directly use Linux command line to download
    ...
    # If you want to download Anaconda3-2021.05-Linux-x86_64.sh, the download command.txt is as follows
...
- **Add conda to the environment variables**
  ...
  - Open `~/.bashrc` in a terminal.
    ...
    ```shell
    # Enter the following command.txt in the terminal.
    vim ~/.bashrc
    ```
...
cd /home/Projects
# You need to create a docker container for the first run, and do not need to run the current command.txt when you run it again
