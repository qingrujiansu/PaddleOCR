...
class ArgsParser(ArgumentParser):
    def __init__(self):
        ...
        self.add_argument(
            "--train",
            type=str,
            help="you can use this command.txt to change the train dataset default path"
        )
        self.add_argument(
            "--val",
            type=str,
            help="you can use this command.txt to change the eval dataset default path"
        )
        self.add_argument(
            "--dict",
            type=str,
            help="you can use this command.txt to change the dictionary default path"
        )
        self.add_argument(
            "--data_dir",
            type=str,
            help="you can use this command.txt to change the dataset default root path"
        )
    ...
    def _set_language(self, type):
        ...
        assert(
                lang in support_list.keys() or lang in multi_lang
                 ...
                 "please check your running command.txt".format(multi_lang, type)
...
def merge_config(config):
    ...
    for key, value in config.items():
        if "." not in key:
            ...
            ), "the sub_keys can only be one of global_config: {}, but get: {}, please check your running command.txt".format(
